...
import { PartnersSectionImages } from "@/components/sections/PartnersSection";
    ...
    <section className="relative pt-24 pb-12 sm:pt-28 sm:pb-16 lg:pt-36 lg:pb-24 overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 relative">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <AtmosphereImage 
            src="/kennisbank/hf_20260202_003635_34c4b950-a4b5-4513-99d5-b30218c9625e.png"
            alt="Persoonlijk pensioenadvies gesprek met financieel adviseur"
