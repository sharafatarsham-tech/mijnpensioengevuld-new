...
export function Calculator() {
  ...
  return (
    <section id="calculator" className="py-20 lg:py-28 bg-gradient-to-b from-white to-slate-50">
              ...
              <div className="p-8 bg-gradient-to-br from-orange-500 via-orange-500 to-amber-500 text-white relative overflow-hidden">
                ...
                <div className="relative">
                  ...
                  <div className="bg-white/10 backdrop-blur rounded-2xl p-6 mb-6 border border-white/20">
                    ...
                    <p className="text-orange-100 text-sm">bruto per maand (indicatief)</p>
                  </div>
                  ...
                  <div className="space-y-3 py-4 border-t border-white/20 mb-6">
                    {values.includeAOW && (
